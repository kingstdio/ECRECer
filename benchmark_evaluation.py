...
LastEditTime: 2023-10-07 06:14:15
...
#region loading results from different methods and make a big DataFrame
...
def filter_newadded_ec(restable):
    #filter newly added ECs by your own
    ## TODO caculate the newly addded ecs in the testing set and filter them
...
if __name__ =='__main__':
    ...
    evalutation_table = filter_newadded_ec(evalutation_table) #filter newly added ECs by your own
